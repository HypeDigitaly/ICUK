...
## PRAVIDLA:
1. Je nutné vytvořit minimálně 5 párů Q&A, ale idedálně více -> dokud se nevyčerpá všechen relevantní a faktický obsah.
...
6. Vynechte irelevantní informace (záhlaví, zápatí, GDPR, cookies, atd.) a další informace, které explicitně přímo nesouvisejí s "{title}".
7. Zajistěte 100% validní JSON.
8. Nepoužívejte vnořené struktury v odpovědích.
